...
# if defined(CLIP)
# define SIZE 1
# elif defined(BLEND1D)
# define SIZE 2
# elif defined(BLEND2D)
# define SIZE 3
# else
# define SIZE 0
# error "Animation Type Not Defined"
# endif
...
#if defined(CLIP)
	BoneMatrices[BoneIndex].M = ToMatrix(TRS[0]);

#elif defined(BLEND1D)
	BoneMatrices[BoneIndex].M = ToMatrix(lerp(TRS[0], TRS[1], AnimData[0].Weight));
