...
namespace sdt
{
	...
	void SkyBoxDemo::LoadCrossQuadGrass()
	{
		...
		MakeRandomGrasses({0,0,0}, {-250, 250}, 7200, 0);
		MakeRandomGrasses({0,0,0}, {-250, 250}, 4500, 1);
		MakeRandomGrasses({0,0,0}, {-250, 250}, 3100, 2);
	}

	void SkyBoxDemo::SetPlane()
	{
	...
	void SkyBoxDemo::SetModelsPosition( int MaxInstanceCount, float Stride )
	{
	...
	void SkyBoxDemo::MakeRandomGrasses(const Vector& Center, const Vector2D& Range, UINT Count, UINT MapIndex)
	{
