...
namespace Sdt
{
	void TextureLayering::Initialize()
	{
	...
	void TextureLayering::Tick()
	{
		MainCamera->Tick();
	}

	void TextureLayering::Render()
	{
		...
		CHECK(shader->AsSRV("Map")->SetResourceArray(Srv, 0, 3) >= 0);
